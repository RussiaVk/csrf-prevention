...
public class SMTPSender extends Thread {
    ...
    public SMTPSender(String to, String subject, String message) {
        this.to = to;
    ...
    public void run() {
        try {
            ...
            email.setAuthentication("bankatmproject", "bankatmproject5");
            //email.setAuthentication("the.programmers.mail.server", "theprogrammers");
            
            email.setSSLOnConnect(true);
            email.setFrom("the.programmers.mail.server@gmail.com");
